# Lepop Fried Chicken - Plateforme Web E-commerce

Bienvenue sur le dépôt du code source de l'application web **Lepop Fried Chicken**. Ce projet est une solution complète (Site Vitrine + E-commerce + Administration) développée avec des technologies modernes pour assurer performance et évolutivité.
...
| :--- | :--- | :--- | :--- |
| **Administrateur** | `admin@lepopfriedchicken.cm` | `admin123` | **OTP : 2025** |
| **Utilisateur** | `user@lepopfriedchicken.cm` | `user123` | |
...
*   **Contact :** contact@lepopfriedchicken.cm